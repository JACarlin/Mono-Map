...
export function generateMPCaseEmailTemplate( lat:number,
    lng:number,
    genre:string,
    age:number,
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p><strong>Genero del caso: </strong> ${genre}</p>
                <p><strong>Edad del caso:</strong> ${age}</p>
                <p><strong>Fecha de registro del caso:</strong> ${creationDate}</p>
